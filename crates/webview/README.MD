...
- [ ] Binary payload + channel optimization: `ipc::Request/Response` covers basic `application/octet-stream` invokes/responses; `__TAURI_CHANNEL__` fast-path is still TODO.
